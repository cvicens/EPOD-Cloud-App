...
var workflows = [
  ...
  { id: "co0MXxxsB", title: 'Questionnaire', steps: [
    {code: 'questionnaire-a1', name: 'Questionnaire A1', templates: {
      form: '<questionnaire-form type="A1"></questionnaire-form>',
      view: '<questionnaire value="result.submission"></questionnaire>'
    }},
    {code: 'questionnaire-b1', name: 'Questionnaire B1', templates: {
      form: '<questionnaire-form type="B1"></questionnaire-form>',
      view: '<questionnaire value="result.submission"></questionnaire>'
    }}
  ]},
